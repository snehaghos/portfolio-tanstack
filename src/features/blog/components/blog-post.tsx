...
export function BlogPostDetail({ post, onBack }: BlogPostProps) {
  return (
    <div className="space-y-6 sm:space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-1000">
      <button
        onClick={onBack}
        className="flex items-center gap-2 text-foreground/60 hover:text-primary transition-colors mb-4 sm:mb-6 text-sm"
      >
      ...
      <div className="space-y-4 sm:space-y-6 prose prose-sm max-w-none description-text">
        ...
        <div dangerouslySetInnerHTML={{ __html: post.footer }} />
        ...
        <div className="border border-gray-200 rounded-lg p-4 sm:p-6 md:p-8 bg-white">
          ...
          <div className="space-y-6">
            <div className="flex gap-3 md:gap-4">
              <div className="w-10 h-10 md:w-12 md:h-12 bg-gray-700 rounded-lg flex items-center justify-center text-white font-bold text-sm md:text-lg flex-shrink-0">
                G
              </div>
              <input
                type="text"
